        ...
        <header className="fixed top-0 w-full z-50 border-b border-gray-800/50 bg-black/80 backdrop-blur-md">
            <nav className="max-w-7xl mx-auto px-6 py-4">
                <div className="flex items-center justify-between">
                    <div className="text-xl font-semibold text-white">MoMo Stocks</div>
...
const Hero = React.memo(() => {
    return (
      ...
      `}</style>
            ...
            >
                Trade Ghana Stock Exchange <br />with Mobile Money
            </h1>

            <p className="text-sm md:text-base text-center max-w-2xl px-6 mb-10" style={{ color: '#9ca3af' }}>
                Real-time GSE data, portfolio tracking, and AI-powered insights. <br />Invest in your future with MoMo Stocks.
            </p>
